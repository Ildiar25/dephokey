...
class TestDatabase(unittest.TestCase):
    ...
    def test_tableExists(self) -> None:
        self.assertTrue(
            self.inspector.has_table("test_table"), msg="Test table doesn't exists."
        )
    ...
    def test_tableAddElement(self) -> None:
        ...
        self.assertTrue(
            test_session.query(TableBuilder).filter_by(id=1).first(),
    ...
    def test_tableQueryFirstElement(self) -> None:
        ...
        self.assertIsInstance(
            element, TableBuilder, msg="Test table DOESN'T FIND first element."
        )
