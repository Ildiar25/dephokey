...
class StringBuilder:
    def __init__(self) -> None:
        ...
        self.__text = (
            "This is a test. All examples used in this session are too basics."
        )
...
class TestMasker(unittest.TestCase):
    ...
    def test_maskerEmailMasked(self) -> None:
        ...
        self.assertEqual(
            self.masked_email,
            mask_email(StringBuilder().build("email")),
    ...
    def test_maskerUsernameExists(self) -> None:
        ...
        self.assertIsNotNone(
            StringBuilder().build("username"), msg="USERNAME doesn't exist."
        )
        log.info(">>> Confirm if USERNAME exists...   OK")

    def test_maskerUsernameType(self) -> None:
        self.assertIsInstance(
            StringBuilder().build("username"), str, msg="Username MUST BE string type."
        )
    ...
    def test_maskerUsernameMasked(self) -> None:
        ...
        self.assertEqual(
            ...
            mask_username(StringBuilder().build("username")),
    ...
    def test_maskerPasswordMasked(self) -> None:
        ...
        self.assertEqual(
            self.masked_password,
            mask_password(StringBuilder().build("password")),
    ...
    def test_maskerNumberExists(self) -> None:
        ...
        self.assertIsNotNone(
            StringBuilder().build("number"), msg="NUMBER doesn't exist."
        )
        log.info(">>> Confirm if NUMBER exists...   OK")

    def test_maskerNumberType(self) -> None:
        self.assertIsInstance(
            StringBuilder().build("number"), str, msg="Number MUST BE string type."
        )
    ...
    def test_maskerNumberMasked(self) -> None:
        ...
        self.assertEqual(
            self.masked_number,
            mask_number(StringBuilder().build("number")),
    ...
    def test_maskerPhoneType(self) -> None:
        self.assertIsInstance(
            StringBuilder().build("phone"), str, msg="Phone MUST BE string type."
        )
    ...
    def test_maskerPhoneMasked(self) -> None:
        ...
        self.assertEqual(
            self.masked_phone,
            mask_phone(StringBuilder().build("phone")),
    ...
    def test_maskerTextType(self) -> None:
        self.assertIsInstance(
            StringBuilder().build("text"), str, msg="Text MUST BE string type."
        )
    ...
    def test_maskerTextMasked(self) -> None:
        ...
        self.assertEqual(
            self.masked_text,
            mask_text(StringBuilder().build("text")),
