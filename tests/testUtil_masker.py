...
class TestMasker(unittest.TestCase):
    ...
    def test_maskerEmailMasked(self) -> None:
        ...
        logger.info(">>> Confirm if EMAIL is MASKED...   OK")
    ...
    def test_maskerUsernameExists(self) -> None:
        ...
        logger.info(">>> Confirm if USERNAME exists...   OK")
    ...
    def test_maskerUsernameType(self) -> None:
        ...
        logger.info(">>> Confirm if USERNAME is instance of STRING...   OK")
    ...
    def test_maskerUsernameMasked(self) -> None:
        ...
        logger.info(">>> Confirm if USERNAME is MASKED...   OK")
    ...
    def test_maskerPasswordMasked(self) -> None:
        ...
        logger.info(">>> Confirm if PASSWORD is MASKED...   OK")
    ...
    def test_maskerNumberMasked(self) -> None:
        ...
        logger.info(">>> Confirm if NUMBER is MASKED...   OK")
    ...
    def test_maskerPhoneMasked(self) -> None:
        ...
        logger.info(">>> Confirm if PHONE is MASKED...   OK")
    ...
    def test_maskerTextMasked(self) -> None:
        ...
        logger.info(">>> Confirm if TEXT is MASKED...   OK")
