            ...
            controls=[
                ...
                ft.Container(
                    ...
                    image=ft.DecorationImage(
                        "interface/assets/bg-image-signup.png", fit=ft.ImageFit.COVER
                    ),
                    content=ft.Stack(
                            ...
                            ft.Column(
                                ...
                                controls=[
                                    ft.Container(
                                        ...
                                        content=ft.Image(
                                            src="interface/assets/signup-passkey.svg",
                                            width=350,
                                        ),
                                    )
                                ],
                            ...
                            ft.Container(
                                ...
                                content=ft.Column(
                                    ...
                                    controls=[
                                        ...
                                        ft.Row(controls=[self.signup_button]),
                                    ],
                                ),
                            ),
                            ft.Container(
    ...
    def create_account(self, _: ft.ControlEvent) -> None:
        ...
        if not password_input == repeat_input:
            ...
            self.snackbar.change_style(
                msg="¡Las contraseñas no coinciden!", style=SnackbarStyle.DANGER
            )
        ...
        if session.query(User).filter(User.email == email_input).first():
            ...
            # Reset Snackbar
            self.snackbar.change_style(
                msg="¡El correo electrónico ya existe!", style=SnackbarStyle.DANGER
            )
            self.snackbar.update()
            return
        ...
        self.snackbar.change_style(
            msg=f"¡Bienvenido/a {new_user.fullname}!", style=SnackbarStyle.SUCCESS
        )
        self.snackbar.update()
