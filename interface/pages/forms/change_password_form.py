...
class ChangePasswordForm(BaseForm):
    def __init__(
        ...
        self.auxiliar_pw = CustomTextField(
            password=True,
            can_reveal_password=True,
            max_length=50,
            on_change=self.__update_field_inputs,
                    ...
                    controls=[
                        ...
                        ft.Row(
                            controls=[
                                TextLink(
                                    text="Generar Contraseña",
                                    function=self.__generate_password,
                                )
                            ]
                        ),
                    ],
    ...
    def __update_password(self, _: ft.ControlEvent) -> None:
        ...
        self.snackbar.change_style(
            msg="¡Contraseña actualizada!", style=SnackbarStyle.SUCCESS
        )
